...
export default function AboutPage() {
  return (
    <SimplePage title="About" subtitle="toy-chat 데모 애플리케이션 소개입니다.">
      <InfoRow label="Frontend" value="React + Vite" />
      <InfoRow label="Backend" value="Express" />
      <InfoRow label="Observability" value="Datadog RUM / APM / Logs" />
      <InfoRow label="LLM" value="OpenAI GPT-5-mini" />
    </SimplePage>
  );
}
