...
exports.lazyLoadProfiler = lazyLoadProfiler;
...
async function lazyLoadProfiler() {
    try {
        return await (0, browser_core_1.mockable)(importProfiler)();
    }
    catch (error) {
...
async function importProfiler() {
    const module = await Promise.resolve().then(() => __importStar(require(/* webpackChunkName: "profiler" */ '../domain/profiling/profiler')));
