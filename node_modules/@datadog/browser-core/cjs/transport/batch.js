...
exports.MESSAGE_BYTES_LIMIT = void 0;
...
exports.MESSAGE_BYTES_LIMIT = 256 * byteUtils_1.ONE_KIBI_BYTE;
function createBatch({ encoder, request, flushController, }) {
    ...
    function addOrUpdate(message, key) {
        ...
        if (estimatedMessageBytesCount >= exports.MESSAGE_BYTES_LIMIT) {
            display_1.display.warn(`Discarded a message whose size was bigger than the maximum allowed size ${exports.MESSAGE_BYTES_LIMIT / byteUtils_1.ONE_KIBI_BYTE}KiB. ${display_1.MORE_DETAILS} ${display_1.DOCS_TROUBLESHOOTING}/#technical-limitations`);
            return;
        }
