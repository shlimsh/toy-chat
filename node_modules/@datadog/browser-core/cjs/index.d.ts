...
export { isExperimentalFeatureEnabled, addExperimentalFeatures, getExperimentalFeatures, initFeatureFlags, ExperimentalFeature, } from './tools/experimentalFeatures';
...
export { startTelemetry, addTelemetryDebug, addTelemetryError, TelemetryService, TelemetryMetrics, addTelemetryConfiguration, addTelemetryUsage, addTelemetryMetrics, } from './domain/telemetry';
...
export { willSyntheticsInjectRum, getSyntheticsContext, isSyntheticsTest, } from './domain/synthetics/syntheticsWorkerValues';
