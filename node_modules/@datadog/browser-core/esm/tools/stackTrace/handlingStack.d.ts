 ...
 */
export declare function createHandlingStack(type: 'console error' | 'action' | 'error' | 'instrumented method' | 'log' | 'react error' | 'nextjs error' | 'vue error' | 'angular error' | 'view' | 'vital'): string;
