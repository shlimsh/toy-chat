...
const RENDER_TIME_GROUPING_THRESHOLD = 8;
/**
...
function trackInteractionToNextPaint(configuration, viewStart, viewLoadingType) {
    ...
    const subPartsTracker = (0, browser_core_1.isExperimentalFeatureEnabled)(browser_core_1.ExperimentalFeature.INP_SUBPARTS)
    ...
    function handleEntries(entries) {
        for (const entry of entries) {
            if (entry.interactionId &&
                ...
                subPartsTracker === null || subPartsTracker === void 0 ? void 0 : subPartsTracker.process(entry);
            }
        }
        subPartsTracker === null || subPartsTracker === void 0 ? void 0 : subPartsTracker.pruneUntracked();
    ...
    function updateCurrentInp(candidate) {
        const newStartTime = (0, browser_core_1.elapsed)(viewStart, candidate.startTime);
        ...
        if (!currentInp || candidate.duration !== currentInp.duration || newStartTime !== currentInp.startTime) {
            let targetSelector = (0, interactionSelectorCache_1.getInteractionSelector)(candidate.startTime);
            if (!targetSelector && candidate.target && (0, htmlDomUtils_1.isElementNode)(candidate.target)) {
                targetSelector = (0, getSelectorFromElement_1.getSelectorFromElement)(candidate.target, configuration.actionNameAttribute);
            }
            currentInp = {
    ...
    return {
        ...
        stop: () => {
            ...
            subPartsTracker === null || subPartsTracker === void 0 ? void 0 : subPartsTracker.stop();
        },
    };
}
/**
...
function createSubPartsTracker(longestInteractions) {
    const groupsByInteractionId = new Map();
    ...
    return {
        ...
        computeSubParts(entry, inpDuration) {
            ...
            return {
                inputDelay: (0, browser_core_1.elapsed)(group.startTime, group.processingStart),
                processingDuration: (0, browser_core_1.elapsed)(group.processingStart, processingEnd),
                presentationDelay: (0, browser_core_1.elapsed)(processingEnd, nextPaintTime),
            };
        },
        stop() {
...
function sanitizeInpValue(inpValue) {
    return Math.min(inpValue, exports.MAX_INP_VALUE);
}
