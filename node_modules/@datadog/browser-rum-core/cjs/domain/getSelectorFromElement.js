...
exports.STABLE_ATTRIBUTES = exports.SHADOW_DOM_MARKER = void 0;
exports.getSelectorFromElement = getSelectorFromElement;
exports.isGeneratedValue = isGeneratedValue;
exports.getIDSelector = getIDSelector;
exports.getTagNameSelector = getTagNameSelector;
exports.getAttributeValueSelector = getAttributeValueSelector;
exports.getNthOfTypeSelector = getNthOfTypeSelector;
 ...
 * parsing logic.
 */
exports.SHADOW_DOM_MARKER = '::shadow ';
/**
...
function getSelectorFromElement(targetElement, actionNameAttribute) {
    ...
    return selectorParts.join(exports.SHADOW_DOM_MARKER);
}
/**
...
function getAllSubtreeTargets(element) {
    ...
    while (currentTarget) {
        ...
        if ((0, htmlDomUtils_1.isNodeShadowRoot)(rootNode)) {
...
function getSelectorFromElementWithinSubtree(targetElement, rootNode, actionNameAttribute) {
    ...
    while (currentElement && currentElement.nodeName !== 'HTML') {
        ...
        const uniqueSelectorAmongChildren = findSelector(currentElement, rootNode, UNIQUE_AMONG_CHILDREN_SELECTOR_GETTERS, isSelectorUniqueAmongSiblings, actionNameAttribute, currentSelector);
