...
exports.shouldMaskAttribute = shouldMaskAttribute;
...
function shouldMaskAttribute(tagName, attributeName, attributeValue, nodePrivacyLevel, configuration) {
    if (nodePrivacyLevel !== privacyConstants_1.NodePrivacyLevel.MASK && nodePrivacyLevel !== privacyConstants_1.NodePrivacyLevel.MASK_UNLESS_ALLOWLISTED) {
        return false;
    }
    if (attributeName === privacyConstants_1.PRIVACY_ATTR_NAME ||
        getSelectorFromElement_1.STABLE_ATTRIBUTES.includes(attributeName) ||
